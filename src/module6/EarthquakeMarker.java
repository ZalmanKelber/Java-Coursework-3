...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public int compareTo(EarthquakeMarker other) {
		float mag = Float.parseFloat(getProperty("magnitude").toString());
		float otherMag = Float.parseFloat(other.getProperty("magnitude").toString());
		return mag == otherMag ? 0 : mag > otherMag ? 1 : -1;
	}
